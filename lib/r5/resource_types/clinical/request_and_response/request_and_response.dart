...
part 'request_and_response.serverpod.dart';
...
@freezed
class Communication extends _i1.TableRow with Resource, _$Communication {
  /// [Communication] A clinical or business level record of information being
  ///  transmitted or shared; e.g. an alert that was sent to a responsible
  ///  provider, a public health agency communication to a provider/reporter in
  ///  response to a case report for a reportable condition.
  ...
  static final CommunicationTable t = CommunicationTable();

  @override
  Map<String, dynamic> toJsonForDatabase() =>
      _$CommunicationToJsonForDatabase(this);
...
class CommunicationRequest extends _i1.TableRow
  ...
  static final CommunicationRequestTable t = CommunicationRequestTable();

  @override
  Map<String, dynamic> toJsonForDatabase() =>
      _$CommunicationRequestToJsonForDatabase(this);
  ...
  static Future<CommunicationRequest?> findSingleRow(
    ...
    _i1.Transaction? transaction,
      ...
      _$CommunicationRequestFindSingleRow(
        session,
        where: where,
        offset: offset,
        orderBy: orderBy,
  ...
  static Future<CommunicationRequest?> findById(
    ...
    int id,
      ...
      _$CommunicationRequestFindById(
        session,
        id,
      );
  ...
  static Future<bool> deleteRow(
    ...
    _i1.Transaction? transaction,
      ...
      _$CommunicationRequestDeleteRow(
        session,
        row,
        transaction: transaction,
      );
...
class DeviceAssociation extends _i1.TableRow
    with Resource, _$DeviceAssociation {
  /// [DeviceAssociation] A record of association or dissociation of a device
  ///  with a patient.
  DeviceAssociation._();
  ...
  ///
  /// [subject] The individual, group of individuals or device that the device
  ///  is on or associated with.
  ///
  ...
  static final DeviceAssociationTable t = DeviceAssociationTable();

  @override
  Map<String, dynamic> toJsonForDatabase() =>
      _$DeviceAssociationToJsonForDatabase(this);
  ...
  static Future<DeviceAssociation?> findSingleRow(
    ...
    _i1.Transaction? transaction,
      ...
      _$DeviceAssociationFindSingleRow(
        session,
        where: where,
        offset: offset,
        orderBy: orderBy,
...
@freezed
class DeviceDispense extends _i1.TableRow with Resource, _$DeviceDispense {
  /// [DeviceDispense] A record of dispensation of a device - i.e., assigning a
  ///  device to a patient, or to a professional for their use.
  DeviceDispense._();
  ...
  ///
  /// [device] Identifies the device being dispensed. This is either a link to
  ///  a resource representing the details of the device or a simple attribute
  ...
  ///  or location where the device was delivered.  This may be a patient or
  ...
  factory DeviceDispense({
    ...
    ///  to a resource representing the details of the device or a simple
    ///  attribute carrying a code that identifies the device from a known list
    ///  of devices.
  ...
  static final DeviceDispenseTable t = DeviceDispenseTable();

  @override
  Map<String, dynamic> toJsonForDatabase() =>
      _$DeviceDispenseToJsonForDatabase(this);
...
@freezed
class DeviceRequest extends _i1.TableRow with Resource, _$DeviceRequest {
  /// [DeviceRequest] Represents a request for a patient to employ a medical
  ...
  ///  patient to either stop using or to not start using the specified device
  ///  or category of devices. For example, the patient has undergone surgery
  ///  and the provider is indicating that the patient should not wear contact
  ///  lenses.
  ///
  /// [doNotPerformElement] ("_doNotPerform") Extensions for doNotPerform
  ///
  ...
  ///  "Every 8 hours"; "Three times a day"; "1/2 an hour before breakfast for
  ...
  static final DeviceRequestTable t = DeviceRequestTable();

  @override
  Map<String, dynamic> toJsonForDatabase() =>
      _$DeviceRequestToJsonForDatabase(this);
...
@freezed
class DeviceUsage extends _i1.TableRow with Resource, _$DeviceUsage {
  ...
  ///  the state of the device used that this statement is about.  Generally
  ...
  factory DeviceUsage({
    ...
    /// [reason] Reason or justification for the use of the device. A coded
    ///  concept, or another resource whose existence justifies this
    ///  DeviceUsage.
    List<CodeableReference>? reason,
  ...
  static final DeviceUsageTable t = DeviceUsageTable();

  @override
  Map<String, dynamic> toJsonForDatabase() =>
      _$DeviceUsageToJsonForDatabase(this);
...
@freezed
class GuidanceResponse extends _i1.TableRow with Resource, _$GuidanceResponse {
  ...
  ///
  /// [moduleCanonicalElement] ("_moduleCanonical") Extensions for
  ///  moduleCanonical
  ///
  ...
  ///  event-based scenarios, it may provide an indication of the cause for the
  ///  response.
  ///
  ...
  ///  produce informational or warning messages. These messages will be
  ///  provided by this element.
  ///
  /// [outputParameters] The output parameters of the evaluation, if any. Many
  ///  modules will result in the return of specific resources such as
  ...
  ///  information, or additional information would potentially result in a
  ...
  factory GuidanceResponse({
    ...
    /// [requestIdentifier] The identifier of the request associated with this
    ///  response. If an identifier was given as part of the request, it will
    ///  be reproduced here to enable the requester to more easily identify the
    ///  response in a multi-request scenario.
    ...
    /// [reason] Describes the reason for the guidance response in coded or
    ///  textual form, or Indicates the reason the request was initiated. This
  ...
  static final GuidanceResponseTable t = GuidanceResponseTable();

  @override
  Map<String, dynamic> toJsonForDatabase() =>
      _$GuidanceResponseToJsonForDatabase(this);
  ...
  static Future<GuidanceResponse?> findSingleRow(
    ...
    _i1.Transaction? transaction,
      ...
      _$GuidanceResponseFindSingleRow(
        session,
        where: where,
        offset: offset,
        orderBy: orderBy,
...
@freezed
class InventoryItem extends _i1.TableRow with Resource, _$InventoryItem {
  /// [InventoryItem] A functional description of an inventory item used in
  ///  inventory and supply-related workflows.
  InventoryItem._();
  ...
  static final InventoryItemTable t = InventoryItemTable();

  @override
  Map<String, dynamic> toJsonForDatabase() =>
      _$InventoryItemToJsonForDatabase(this);
...
class InventoryItemDescription with _$InventoryItemDescription {
  ...
  ///  described in different languages and those languages may be
  ///  authoritative and not translations of a 'main' language.
  ///
  /// [languageElement] ("_language") Extensions for language
  ///
...
class InventoryItemAssociation with _$InventoryItemAssociation {
  ...
  ///  quantity of the present product. For example a value of 20 means that
  ///  this product contains 20 units of the related product; a value of 1:20
  ...
  factory InventoryItemAssociation({
    ...
    ///  quantity of the present product. For example a value of 20 means that
    ///  this product contains 20 units of the related product; a value of 1:20
    ///  means the inverse - that the contained product contains 20 units of
    ///  the present product.
...
@freezed
class InventoryReport extends _i1.TableRow with Resource, _$InventoryReport {
  /// [InventoryReport] A report of inventory or stock items.
  InventoryReport._();
  ...
  factory InventoryReport({
    ...
    ///  this is draft (e.g. the report is still pending some updates) or
    ///  active.
    FhirCode? status,
  ...
  static final InventoryReportTable t = InventoryReportTable();

  @override
  Map<String, dynamic> toJsonForDatabase() =>
      _$InventoryReportToJsonForDatabase(this);
  ...
  static Future<InventoryReport?> findSingleRow(
    ...
    _i1.Transaction? transaction,
      ...
      _$InventoryReportFindSingleRow(
        session,
        where: where,
        offset: offset,
        orderBy: orderBy,
...
class InventoryReportItem with _$InventoryReportItem {
  ...
  factory InventoryReportItem({
    ...
    /// [category] The inventory category or classification of the items being
    ///  reported. This is meant not for defining the product, but for
    ///  inventory categories e.g. 'pending recount' or 'damaged'.
...
@freezed
class SupplyDelivery extends _i1.TableRow with Resource, _$SupplyDelivery {
  /// [SupplyDelivery] Record of delivery of what is supplied.
  SupplyDelivery._();
  ...
  static final SupplyDeliveryTable t = SupplyDeliveryTable();

  @override
  Map<String, dynamic> toJsonForDatabase() =>
      _$SupplyDeliveryToJsonForDatabase(this);
...
class SupplyDeliverySuppliedItem with _$SupplyDeliverySuppliedItem {
  ...
  factory SupplyDeliverySuppliedItem({
    ...
    /// [itemCodeableConcept] Identifies the medication, substance, device or
    ///  biologically derived product being supplied. This is either a link to
...
@freezed
class SupplyRequest extends _i1.TableRow with Resource, _$SupplyRequest {
  ...
  static final SupplyRequestTable t = SupplyRequestTable();

  @override
  Map<String, dynamic> toJsonForDatabase() =>
      _$SupplyRequestToJsonForDatabase(this);
