...
///  cost centers, etc.
@freezed
class Account extends _i1.TableRow with Resource, _$Account {
  /// [Account] A financial tool for tracking value accrued for a particular
  ///  purpose.  In the healthcare field, used to track charges for a patient,
  ///  cost centers, etc.
  Account._();
  ...
  static final AccountTable t = AccountTable();

  @override
  Map<String, dynamic> toJsonForDatabase() => _$AccountToJsonForDatabase(this);
...
///  patient, cost centers, etc.
@freezed
class AccountDiagnosis with _$AccountDiagnosis {
  /// [AccountDiagnosis] A financial tool for tracking value accrued for a
  ///  particular purpose.  In the healthcare field, used to track charges for
  ///  a patient, cost centers, etc.
  AccountDiagnosis._();
...
///  patient, cost centers, etc.
@freezed
class AccountProcedure with _$AccountProcedure {
  /// [AccountProcedure] A financial tool for tracking value accrued for a
  ///  particular purpose.  In the healthcare field, used to track charges for
  ///  a patient, cost centers, etc.
  AccountProcedure._();
  ...
  ///  using a reference to a procedure, then the date on the procedure should
  ///  be used.
  ///
...
///  allocation.
@freezed
class ChargeItem extends _i1.TableRow with Resource, _$ChargeItem {
  ...
  static final ChargeItemTable t = ChargeItemTable();

  @override
  Map<String, dynamic> toJsonForDatabase() =>
      _$ChargeItemToJsonForDatabase(this);
...
@freezed
class ChargeItemDefinition extends _i1.TableRow
  ...
  static final ChargeItemDefinitionTable t = ChargeItemDefinitionTable();

  @override
  Map<String, dynamic> toJsonForDatabase() =>
      _$ChargeItemDefinitionToJsonForDatabase(this);

  @override
  String get tableName => 'ChargeItemDefinition';

  static Future<List<ChargeItemDefinition>> find(
    _i1.Session session, {
  ...
  static Future<ChargeItemDefinition?> findSingleRow(
    _i1.Session session, {
    ChargeItemDefinitionExpressionBuilder? where,
    int? offset,
    _i1.Column? orderBy,
    ...
    _i1.Transaction? transaction,
      ...
      _$ChargeItemDefinitionFindSingleRow(
        session,
        where: where,
        offset: offset,
        orderBy: orderBy,
  ...
  static Future<ChargeItemDefinition?> findById(
    _i1.Session session,
    int id,
  ) async =>
      _$ChargeItemDefinitionFindById(
        session,
        id,
      );
  ...
  static Future<bool> deleteRow(
    ...
    _i1.Transaction? transaction,
      ...
      _$ChargeItemDefinitionDeleteRow(
        session,
        row,
        transaction: transaction,
      );
...
@freezed
class Contract extends _i1.TableRow with Resource, _$Contract {
  /// [Contract] Legally enforceable, formally recorded unilateral or bilateral
  ///  directive i.e., a policy or agreement.
  Contract._();
  ...
  static final ContractTable t = ContractTable();

  @override
  Map<String, dynamic> toJsonForDatabase() => _$ContractToJsonForDatabase(this);
...
class ExplanationOfBenefit extends _i1.TableRow
  ...
  static final ExplanationOfBenefitTable t = ExplanationOfBenefitTable();

  @override
  Map<String, dynamic> toJsonForDatabase() =>
      _$ExplanationOfBenefitToJsonForDatabase(this);
  ...
  static Future<ExplanationOfBenefit?> findSingleRow(
    ...
    _i1.Transaction? transaction,
      ...
      _$ExplanationOfBenefitFindSingleRow(
        session,
        where: where,
        offset: offset,
        orderBy: orderBy,
  ...
  static Future<ExplanationOfBenefit?> findById(
    ...
    int id,
      ...
      _$ExplanationOfBenefitFindById(
        session,
        id,
      );
  ...
  static Future<bool> deleteRow(
    ...
    _i1.Transaction? transaction,
      ...
      _$ExplanationOfBenefitDeleteRow(
        session,
        row,
        transaction: transaction,
      );
...
///  provided.
@freezed
class ExplanationOfBenefitEvent with _$ExplanationOfBenefitEvent {
  /// [ExplanationOfBenefitEvent] This resource provides: the claim details;
  ///  adjudication details from the processing of a Claim; and optionally
  ///  account balance information, for informing the subscriber of the
  ///  benefits provided.
...
///  organization.
@freezed
class InsurancePlan extends _i1.TableRow with Resource, _$InsurancePlan {
  /// [InsurancePlan] Details of a Health Insurance product/plan provided by an
  ///  organization.
  InsurancePlan._();
  ...
  factory InsurancePlan({
    ...
    /// [identifier] Business identifiers assigned to this health insurance
    ///  product which remain constant as the resource is updated and
    ...
    ///  and underwriting the risk.  This is typically an insurance carriers,
    ///  other third-party payers, or health plan sponsors comonly referred to
    ///  as 'payers'.
    Reference? ownedBy,

    /// [administeredBy] An organization which administer other services such
    ///  as underwriting, customer service and/or claims processing on behalf
    ///  of the health insurance product owner.
    ...
    ///  relevant to the specific Insurance Plan/Product. This can include
  ...
  static final InsurancePlanTable t = InsurancePlanTable();

  @override
  Map<String, dynamic> toJsonForDatabase() =>
      _$InsurancePlanToJsonForDatabase(this);
...
class InsurancePlanPlan with _$InsurancePlanPlan {
  ...
  factory InsurancePlanPlan({
    ...
    /// [identifier] Business identifiers assigned to this health insurance
    ///  plan which remain constant as the resource is updated and propagates
    ///  from server to server.
    List<Identifier>? identifier,
