...
class ElementDefinition with _$ElementDefinition {
  ...
  ///  the instance, if the element has a value. Other additional values may be
  ...
  ///  by conformant consumers that support the element. ```maxLength``` SHOULD
  ///  only be used on primitive data types that have a string representation
  ///  (see
