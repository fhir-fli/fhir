...
class CapabilityStatement with Resource, _$CapabilityStatement {
  ...
  const factory CapabilityStatement({
    /// [resourceType] This is a CapabilityStatement resource
    @Default(R6ResourceType.CapabilityStatement)
    @JsonKey(unknownEnumValue: R6ResourceType.CapabilityStatement)
...
class CompartmentDefinition with Resource, _$CompartmentDefinition {
  ...
  const factory CompartmentDefinition({
    /// [resourceType] This is a CompartmentDefinition resource
    @Default(R6ResourceType.CompartmentDefinition)
    @JsonKey(unknownEnumValue: R6ResourceType.CompartmentDefinition)
    R6ResourceType resourceType,
...
class GraphDefinition with Resource, _$GraphDefinition {
  ...
  const factory GraphDefinition({
    /// [resourceType] This is a GraphDefinition resource
    @Default(R6ResourceType.GraphDefinition)
    @JsonKey(unknownEnumValue: R6ResourceType.GraphDefinition)
    R6ResourceType resourceType,
...
class ImplementationGuide with Resource, _$ImplementationGuide {
  ...
  const factory ImplementationGuide({
    /// [resourceType] This is a ImplementationGuide resource
    @Default(R6ResourceType.ImplementationGuide)
    @JsonKey(unknownEnumValue: R6ResourceType.ImplementationGuide)
    R6ResourceType resourceType,
...
class MessageDefinition with Resource, _$MessageDefinition {
  ...
  const factory MessageDefinition({
    /// [resourceType] This is a MessageDefinition resource
    @Default(R6ResourceType.MessageDefinition)
    @JsonKey(unknownEnumValue: R6ResourceType.MessageDefinition)
    R6ResourceType resourceType,
...
class OperationDefinition with Resource, _$OperationDefinition {
  ...
  const factory OperationDefinition({
    /// [resourceType] This is a OperationDefinition resource
    @Default(R6ResourceType.OperationDefinition)
    @JsonKey(unknownEnumValue: R6ResourceType.OperationDefinition)
    R6ResourceType resourceType,
...
class SearchParameter with Resource, _$SearchParameter {
  ...
  const factory SearchParameter({
    /// [resourceType] This is a SearchParameter resource
    @Default(R6ResourceType.SearchParameter)
    @JsonKey(unknownEnumValue: R6ResourceType.SearchParameter)
    R6ResourceType resourceType,
...
class StructureDefinition with Resource, _$StructureDefinition {
  ...
  const factory StructureDefinition({
    /// [resourceType] This is a StructureDefinition resource
    @Default(R6ResourceType.StructureDefinition)
    @JsonKey(unknownEnumValue: R6ResourceType.StructureDefinition)
    R6ResourceType resourceType,
...
class StructureMap with Resource, _$StructureMap {
  ...
  const factory StructureMap({
    /// [resourceType] This is a StructureMap resource
    @Default(R6ResourceType.StructureMap)
    @JsonKey(unknownEnumValue: R6ResourceType.StructureMap)
    R6ResourceType resourceType,
