...
class AdministrableProductDefinition
  ...
  const factory AdministrableProductDefinition({
    /// [resourceType] This is a AdministrableProductDefinition resource
    @Default(R6ResourceType.AdministrableProductDefinition)
    @JsonKey(unknownEnumValue: R6ResourceType.AdministrableProductDefinition)
...
class ClinicalUseDefinition with Resource, _$ClinicalUseDefinition {
  ...
  ///  which this is an indication, contraindication, interaction, undesirable
  ///  effect, or warning.
  ///
  ...
  const factory ClinicalUseDefinition({
    /// [resourceType] This is a ClinicalUseDefinition resource
    @Default(R6ResourceType.ClinicalUseDefinition)
    @JsonKey(unknownEnumValue: R6ResourceType.ClinicalUseDefinition)
    R6ResourceType resourceType,
    ...
    ///  for which this is an indication, contraindication, interaction,
...
class Ingredient with Resource, _$Ingredient {
  ...
  const factory Ingredient({
    /// [resourceType] This is a Ingredient resource
    @Default(R6ResourceType.Ingredient)
    @JsonKey(unknownEnumValue: R6ResourceType.Ingredient)
    R6ResourceType resourceType,
...
class ManufacturedItemDefinition with Resource, _$ManufacturedItemDefinition {
  ...
  const factory ManufacturedItemDefinition({
    /// [resourceType] This is a ManufacturedItemDefinition resource
    @Default(R6ResourceType.ManufacturedItemDefinition)
    @JsonKey(unknownEnumValue: R6ResourceType.ManufacturedItemDefinition)
    R6ResourceType resourceType,
...
class MedicinalProductDefinition with Resource, _$MedicinalProductDefinition {
  ...
  const factory MedicinalProductDefinition({
    /// [resourceType] This is a MedicinalProductDefinition resource
    @Default(R6ResourceType.MedicinalProductDefinition)
    @JsonKey(unknownEnumValue: R6ResourceType.MedicinalProductDefinition)
    R6ResourceType resourceType,
...
class PackagedProductDefinition with Resource, _$PackagedProductDefinition {
  ...
  const factory PackagedProductDefinition({
    /// [resourceType] This is a PackagedProductDefinition resource
    @Default(R6ResourceType.PackagedProductDefinition)
    @JsonKey(unknownEnumValue: R6ResourceType.PackagedProductDefinition)
    R6ResourceType resourceType,
...
class RegulatedAuthorization with Resource, _$RegulatedAuthorization {
  ...
  const factory RegulatedAuthorization({
    /// [resourceType] This is a RegulatedAuthorization resource
    @Default(R6ResourceType.RegulatedAuthorization)
    @JsonKey(unknownEnumValue: R6ResourceType.RegulatedAuthorization)
    R6ResourceType resourceType,
...
class SubstanceDefinition with Resource, _$SubstanceDefinition {
  ...
  const factory SubstanceDefinition({
    /// [resourceType] This is a SubstanceDefinition resource
    @Default(R6ResourceType.SubstanceDefinition)
    @JsonKey(unknownEnumValue: R6ResourceType.SubstanceDefinition)
    R6ResourceType resourceType,
...
class SubstanceNucleicAcid with Resource, _$SubstanceNucleicAcid {
  ...
  const factory SubstanceNucleicAcid({
    /// [resourceType] This is a SubstanceNucleicAcid resource
    @Default(R6ResourceType.SubstanceNucleicAcid)
    @JsonKey(unknownEnumValue: R6ResourceType.SubstanceNucleicAcid)
    R6ResourceType resourceType,
...
class SubstancePolymer with Resource, _$SubstancePolymer {
  ...
  const factory SubstancePolymer({
    /// [resourceType] This is a SubstancePolymer resource
    @Default(R6ResourceType.SubstancePolymer)
    @JsonKey(unknownEnumValue: R6ResourceType.SubstancePolymer)
    R6ResourceType resourceType,
...
class SubstanceProtein with Resource, _$SubstanceProtein {
  ...
  const factory SubstanceProtein({
    /// [resourceType] This is a SubstanceProtein resource
    @Default(R6ResourceType.SubstanceProtein)
    @JsonKey(unknownEnumValue: R6ResourceType.SubstanceProtein)
    R6ResourceType resourceType,
...
class SubstanceReferenceInformation
  ...
  const factory SubstanceReferenceInformation({
    /// [resourceType] This is a SubstanceReferenceInformation resource
    @Default(R6ResourceType.SubstanceReferenceInformation)
    @JsonKey(unknownEnumValue: R6ResourceType.SubstanceReferenceInformation)
    R6ResourceType resourceType,
...
class SubstanceSourceMaterial with Resource, _$SubstanceSourceMaterial {
  ...
  const factory SubstanceSourceMaterial({
    /// [resourceType] This is a SubstanceSourceMaterial resource
    @Default(R6ResourceType.SubstanceSourceMaterial)
    @JsonKey(unknownEnumValue: R6ResourceType.SubstanceSourceMaterial)
    R6ResourceType resourceType,
