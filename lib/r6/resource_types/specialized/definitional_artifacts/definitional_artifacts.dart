...
class ActivityDefinition with Resource, _$ActivityDefinition {
  ...
  const factory ActivityDefinition({
    /// [resourceType] This is a ActivityDefinition resource
    @Default(R6ResourceType.ActivityDefinition)
    @JsonKey(unknownEnumValue: R6ResourceType.ActivityDefinition)
...
class ActorDefinition with Resource, _$ActorDefinition {
  ...
  const factory ActorDefinition({
    /// [resourceType] This is a ActorDefinition resource
    @Default(R6ResourceType.ActorDefinition)
    @JsonKey(unknownEnumValue: R6ResourceType.ActorDefinition)
    R6ResourceType resourceType,
...
class ConditionDefinition with Resource, _$ConditionDefinition {
  ...
  const factory ConditionDefinition({
    /// [resourceType] This is a ConditionDefinition resource
    @Default(R6ResourceType.ConditionDefinition)
    @JsonKey(unknownEnumValue: R6ResourceType.ConditionDefinition)
    R6ResourceType resourceType,
...
class DeviceDefinition with Resource, _$DeviceDefinition {
  ...
  const factory DeviceDefinition({
    /// [resourceType] This is a DeviceDefinition resource
    @Default(R6ResourceType.DeviceDefinition)
    @JsonKey(unknownEnumValue: R6ResourceType.DeviceDefinition)
    R6ResourceType resourceType,
...
class EventDefinition with Resource, _$EventDefinition {
  ...
  const factory EventDefinition({
    /// [resourceType] This is a EventDefinition resource
    @Default(R6ResourceType.EventDefinition)
    @JsonKey(unknownEnumValue: R6ResourceType.EventDefinition)
    R6ResourceType resourceType,
...
class ExampleScenario with Resource, _$ExampleScenario {
  ...
  const factory ExampleScenario({
    /// [resourceType] This is a ExampleScenario resource
    @Default(R6ResourceType.ExampleScenario)
    @JsonKey(unknownEnumValue: R6ResourceType.ExampleScenario)
    R6ResourceType resourceType,
...
class ObservationDefinition with Resource, _$ObservationDefinition {
  ...
  const factory ObservationDefinition({
    /// [resourceType] This is a ObservationDefinition resource
    @Default(R6ResourceType.ObservationDefinition)
    @JsonKey(unknownEnumValue: R6ResourceType.ObservationDefinition)
    R6ResourceType resourceType,
...
class PlanDefinition with Resource, _$PlanDefinition {
  ...
  const factory PlanDefinition({
    /// [resourceType] This is a PlanDefinition resource
    @Default(R6ResourceType.PlanDefinition)
    @JsonKey(unknownEnumValue: R6ResourceType.PlanDefinition)
    R6ResourceType resourceType,
...
class Questionnaire with Resource, _$Questionnaire {
  ...
  const factory Questionnaire({
    /// [resourceType] This is a Questionnaire resource
    @Default(R6ResourceType.Questionnaire)
    @JsonKey(unknownEnumValue: R6ResourceType.Questionnaire)
    R6ResourceType resourceType,
...
class Requirements with Resource, _$Requirements {
  ...
  const factory Requirements({
    /// [resourceType] This is a Requirements resource
    @Default(R6ResourceType.Requirements)
    @JsonKey(unknownEnumValue: R6ResourceType.Requirements)
    R6ResourceType resourceType,
...
class SpecimenDefinition with Resource, _$SpecimenDefinition {
  ...
  const factory SpecimenDefinition({
    /// [resourceType] This is a SpecimenDefinition resource
    @Default(R6ResourceType.SpecimenDefinition)
    @JsonKey(unknownEnumValue: R6ResourceType.SpecimenDefinition)
    R6ResourceType resourceType,
