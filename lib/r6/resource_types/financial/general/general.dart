...
class Account with Resource, _$Account {
  ...
  ///  including any inpatient appointments, and possibly re-admissions, of the
  ///  billing for those re-admissions should be grouped with the initial
  ...
  const factory Account({
    /// [resourceType] This is a Account resource
    @Default(R6ResourceType.Account)
...
class ChargeItem with Resource, _$ChargeItem {
  ...
  const factory ChargeItem({
    /// [resourceType] This is a ChargeItem resource
    @Default(R6ResourceType.ChargeItem)
...
class ChargeItemDefinition with Resource, _$ChargeItemDefinition {
  ...
  const factory ChargeItemDefinition({
    /// [resourceType] This is a ChargeItemDefinition resource
    @Default(R6ResourceType.ChargeItemDefinition)
...
class Contract with Resource, _$Contract {
  ...
  const factory Contract({
    /// [resourceType] This is a Contract resource
    @Default(R6ResourceType.Contract)
...
class ExplanationOfBenefit with Resource, _$ExplanationOfBenefit {
  ...
  const factory ExplanationOfBenefit({
    /// [resourceType] This is a ExplanationOfBenefit resource
    @Default(R6ResourceType.ExplanationOfBenefit)
...
/// [InsurancePlan] Details about an insurance plan.
@freezed
class InsurancePlan with Resource, _$InsurancePlan {
  ...
  ///  meaning of modifierExtension itself).
  ///
  /// [identifier] Identifiers, such as the plan ID and/or group ID associated
  ...
  const factory InsurancePlan({
    /// [resourceType] This is a InsurancePlan resource
    @Default(R6ResourceType.InsurancePlan)
...
/// [InsurancePlanGeneralCost] Details about an insurance plan.
@freezed
...
/// [InsurancePlanSpecificCost] Details about an insurance plan.
@freezed
...
/// [InsurancePlanBenefit] Details about an insurance plan.
@freezed
...
/// [InsurancePlanCost] Details about an insurance plan.
@freezed
