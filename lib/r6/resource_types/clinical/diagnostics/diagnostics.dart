...
class BodyStructure with Resource, _$BodyStructure {
  ...
  const factory BodyStructure({
    /// [resourceType] This is a BodyStructure resource
    @Default(R6ResourceType.BodyStructure)
    @JsonKey(unknownEnumValue: R6ResourceType.BodyStructure)
...
class DiagnosticReport with Resource, _$DiagnosticReport {
  ...
  const factory DiagnosticReport({
    /// [resourceType] This is a DiagnosticReport resource
    @Default(R6ResourceType.DiagnosticReport)
    @JsonKey(unknownEnumValue: R6ResourceType.DiagnosticReport)
    R6ResourceType resourceType,
...
class GenomicStudy with Resource, _$GenomicStudy {
  ...
  const factory GenomicStudy({
    /// [resourceType] This is a GenomicStudy resource
    @Default(R6ResourceType.GenomicStudy)
    @JsonKey(unknownEnumValue: R6ResourceType.GenomicStudy)
    R6ResourceType resourceType,
...
class ImagingSelection with Resource, _$ImagingSelection {
  ...
  const factory ImagingSelection({
    /// [resourceType] This is a ImagingSelection resource
    @Default(R6ResourceType.ImagingSelection)
    @JsonKey(unknownEnumValue: R6ResourceType.ImagingSelection)
    R6ResourceType resourceType,
...
class ImagingStudy with Resource, _$ImagingStudy {
  ...
  const factory ImagingStudy({
    /// [resourceType] This is a ImagingStudy resource
    @Default(R6ResourceType.ImagingStudy)
    @JsonKey(unknownEnumValue: R6ResourceType.ImagingStudy)
    R6ResourceType resourceType,
...
class MolecularSequence with Resource, _$MolecularSequence {
  ...
  const factory MolecularSequence({
    /// [resourceType] This is a MolecularSequence resource
    @Default(R6ResourceType.MolecularSequence)
    @JsonKey(unknownEnumValue: R6ResourceType.MolecularSequence)
    R6ResourceType resourceType,
...
class Observation with Resource, _$Observation {
  ...
  const factory Observation({
    /// [resourceType] This is a Observation resource
    @Default(R6ResourceType.Observation)
    @JsonKey(unknownEnumValue: R6ResourceType.Observation)
    R6ResourceType resourceType,
...
class QuestionnaireResponse with Resource, _$QuestionnaireResponse {
  ...
  const factory QuestionnaireResponse({
    /// [resourceType] This is a QuestionnaireResponse resource
    @Default(R6ResourceType.QuestionnaireResponse)
    @JsonKey(unknownEnumValue: R6ResourceType.QuestionnaireResponse)
    R6ResourceType resourceType,
...
class Specimen with Resource, _$Specimen {
  ...
  const factory Specimen({
    /// [resourceType] This is a Specimen resource
    @Default(R6ResourceType.Specimen)
    @JsonKey(unknownEnumValue: R6ResourceType.Specimen)
    R6ResourceType resourceType,
