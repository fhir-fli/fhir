...
class Communication with Resource, _$Communication {
  ...
  const factory Communication({
    /// [resourceType] This is a Communication resource
    @Default(R6ResourceType.Communication)
    @JsonKey(unknownEnumValue: R6ResourceType.Communication)
...
class CommunicationRequest with Resource, _$CommunicationRequest {
  ...
  const factory CommunicationRequest({
    /// [resourceType] This is a CommunicationRequest resource
    @Default(R6ResourceType.CommunicationRequest)
    @JsonKey(unknownEnumValue: R6ResourceType.CommunicationRequest)
    R6ResourceType resourceType,
...
class DeviceAssociation with Resource, _$DeviceAssociation {
  ...
  const factory DeviceAssociation({
    /// [resourceType] This is a DeviceAssociation resource
    @Default(R6ResourceType.DeviceAssociation)
    @JsonKey(unknownEnumValue: R6ResourceType.DeviceAssociation)
    R6ResourceType resourceType,
...
class DeviceDispense with Resource, _$DeviceDispense {
  ...
  const factory DeviceDispense({
    /// [resourceType] This is a DeviceDispense resource
    @Default(R6ResourceType.DeviceDispense)
    @JsonKey(unknownEnumValue: R6ResourceType.DeviceDispense)
    R6ResourceType resourceType,
...
class DeviceRequest with Resource, _$DeviceRequest {
  ...
  const factory DeviceRequest({
    /// [resourceType] This is a DeviceRequest resource
    @Default(R6ResourceType.DeviceRequest)
    @JsonKey(unknownEnumValue: R6ResourceType.DeviceRequest)
    R6ResourceType resourceType,
...
class DeviceUsage with Resource, _$DeviceUsage {
  ...
  const factory DeviceUsage({
    /// [resourceType] This is a DeviceUsage resource
    @Default(R6ResourceType.DeviceUsage)
    @JsonKey(unknownEnumValue: R6ResourceType.DeviceUsage)
    R6ResourceType resourceType,
...
class GuidanceResponse with Resource, _$GuidanceResponse {
  ...
  const factory GuidanceResponse({
    /// [resourceType] This is a GuidanceResponse resource
    @Default(R6ResourceType.GuidanceResponse)
    @JsonKey(unknownEnumValue: R6ResourceType.GuidanceResponse)
    R6ResourceType resourceType,
...
class InventoryItem with Resource, _$InventoryItem {
  ...
  const factory InventoryItem({
    /// [resourceType] This is a InventoryItem resource
    @Default(R6ResourceType.InventoryItem)
    @JsonKey(unknownEnumValue: R6ResourceType.InventoryItem)
    R6ResourceType resourceType,
...
class InventoryReport with Resource, _$InventoryReport {
  ...
  const factory InventoryReport({
    /// [resourceType] This is a InventoryReport resource
    @Default(R6ResourceType.InventoryReport)
    @JsonKey(unknownEnumValue: R6ResourceType.InventoryReport)
    R6ResourceType resourceType,
...
class SupplyDelivery with Resource, _$SupplyDelivery {
  ...
  const factory SupplyDelivery({
    /// [resourceType] This is a SupplyDelivery resource
    @Default(R6ResourceType.SupplyDelivery)
    @JsonKey(unknownEnumValue: R6ResourceType.SupplyDelivery)
    R6ResourceType resourceType,
...
class SupplyRequest with Resource, _$SupplyRequest {
  ...
  const factory SupplyRequest({
    /// [resourceType] This is a SupplyRequest resource
    @Default(R6ResourceType.SupplyRequest)
    @JsonKey(unknownEnumValue: R6ResourceType.SupplyRequest)
    R6ResourceType resourceType,
